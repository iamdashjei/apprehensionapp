...
import 'package:pnpdict/src/pages/chatroom/chat_page_mobile.dart';
  ...
  Future<void> _showNotification(String message, FlutterLocalNotificationsPlugin flutterLocalNotificationsPlugin, String id, String channelId) async {
    ...
    if(notify == null){
      var androidPlatformChannelSpecifics = AndroidNotificationDetails(
          channelId, 'pnpdictchannel', 'pnpdictapp',
      ...
      if(notify != "notified"){
        ...
        var platformChannelSpecifics = NotificationDetails(
            androidPlatformChannelSpecifics, iOSPlatformChannelSpecifics);
        await flutterLocalNotificationsPlugin.show(
            int.parse(id), 'PNPDict', message, platformChannelSpecifics,
            payload: 'item x');
        //AudioPlayer audioPlayer;
